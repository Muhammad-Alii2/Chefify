...
import UserInfo from './UserInfo';  // Import the UserInfo Client Component

async function Herosection() {
  const session = await getAuthSession();  // Fetch session details

  return (
    <div>
      <UserInfo session={session} />  {/* Pass the session to UserInfo */}
